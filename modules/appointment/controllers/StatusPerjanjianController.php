...
class StatusPerjanjianController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if (!empty($user)) {
            ...
            if ($requestData['token_core'] == $tokenCore) {
                ...
                $url = $endpoint->url . '?r=mobile/service-list-umum/status-perjanjian';
                ...
                if ($response->isOk) {
                    ...
                    return [
                        'error' => true,
                        'message' => 'Gagal mengambil status perjanjian',
